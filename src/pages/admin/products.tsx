                  ...
                  products.map((product: any) => (
                    ...
                    >
                      <TableCell className="px-4 py-2">
                        <Link
                          to={PUBLIC_ROUTES.PRODUCT_DETAIL.replace(
                            ":slug",
                            product.slug,
                          )}
                      ...
                      <TableCell className="px-2 py-2">
                        <span
                          className={`font-semibold ${product.stockCount === 0 ? "text-destructive" : "text-foreground"}`}
                        >
                          {product.stockCount}
                        </span>
                      </TableCell>
                      <TableCell className="px-2 py-2">
                        <Badge
                          variant={
                            product.stockCount > 0 ? "default" : "destructive"
                          }
                          className={
